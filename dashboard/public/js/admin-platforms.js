      ...
      <td data-label="Actions" class="col-actions">
        <div class="row-actions-dropdown">
          ...
          <div class="row-actions-menu">
            <button class="row-action-menu-item edit-plat-btn" data-id="${p.id}" type="button">
            ...
            <button class="row-action-menu-item del-plat-btn" data-id="${p.id}" type="button" style="color:var(--danger);">
